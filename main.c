...
int main()
{
	...
	struct spi_init_param ad9208_0_spi_param = {
		...
		.platform_ops = NULL, //&xil_spi_ops,
		.extra = NULL //&xil_spi_param
	};
	...
	struct ad9208_init_param ad9208_0_param = {
		...
		.gpio_powerdown = {
			...
			.platform_ops = NULL, //&xil_gpio_ops,
			.extra = NULL, //&xilinx_gpio_init_param
		},
		...
		.ddc = NULL, //ad9208_0_ddc_init,
		.ddc_cnt = NULL, //ARRAY_SIZE(ad9208_0_ddc_init),
	...
	if (status != SUCCESS) {
		printf("ad9208_0_init() error: %"PRIi32"\n", status);
	}
}